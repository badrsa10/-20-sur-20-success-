...
public class ScrollableTabsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addEvent.setOnClickListener((View v) -> {
            Intent intent = new Intent(ScrollableTabsActivity.this,AddEvent.class);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ScrollableTabsActivity.this,Teacher.class);
        Bundle bundle = new Bundle();
        bundle.putString("mail",mail);
        bundle.putString("prenonnom",getIntent().getExtras().getString("prenonnom"));
        bundle.putString("tel",getIntent().getExtras().getString("tel"));
