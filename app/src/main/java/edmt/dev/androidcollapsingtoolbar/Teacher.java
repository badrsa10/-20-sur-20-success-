...
public class Teacher extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editor.putString("matiere",mybi.getString("matiere"));
        editor.putString("prix",mybi.getString("prix"));
        editor.putInt("tag",tag);
        editor.commit();


        new code().execute(mail,String.valueOf(latti_teacher),String.valueOf(longi_teacher));

        calendar = findViewById(R.id.calendar);
        calendar.setOnClickListener((View v) -> {
            Intent intent = new Intent(Teacher.this,ScrollableTabsActivity.class);
            Bundle bundle = new Bundle();
            bundle.putString("mail",mail);
            bundle.putString("prenonnom",mybi.getString("prenonnom"));
            bundle.putString("tel",mybi.getString("tel"));
            bundle.putString("niveau",mybi.getString("niveau"));
            bundle.putString("matiere",mybi.getString("matiere"));
            bundle.putString("prix",mybi.getString("prix"));
    ...
    private class code extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Teacher.this);
